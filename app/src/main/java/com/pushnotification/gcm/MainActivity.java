...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.pushnotification.gcm.R.layout.activity_main);
        Toolbar toolbar = (Toolbar) findViewById(com.pushnotification.gcm.R.id.toolbar);
    ...
    private void initViews(){
        btn_register = (Button) findViewById(com.pushnotification.gcm.R.id.btn_register);
    ...
    private BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(intent.getAction().equals(REGISTRATION_PROCESS)){
                ...
                Snackbar.make(findViewById(com.pushnotification.gcm.R.id.coordinatorLayout),result + " : " + message,Snackbar.LENGTH_SHORT).show();
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_CODE:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Snackbar.make(findViewById(com.pushnotification.gcm.R.id.coordinatorLayout),"Permission Denied, Please allow to proceed !.",Snackbar.LENGTH_LONG).show();
