...
public class RegistrationIntentService extends IntentService{
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            String registrationId = instanceID.getToken(getString(com.pushnotification.gcm.R.string.gcm_defaultSenderId), GoogleCloudMessaging.INSTANCE_ID_SCOPE, null);
    ...
    private void registerDeviceProcess(String deviceName, String deviceId, String registrationId){
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("http://gcmserver.54.208.194.189.xip.io/")
